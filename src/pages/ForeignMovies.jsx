...
const LANGUAGES = ["Korean", "French", "Japanese", "Chinese", "Spanish", "Turkish", "German", "Italian", "Iranian", "Thai", "Russian", "Hindi Dubbed"];
const PAGE_SIZE = 60;
      ...
      <div className="sg-header">
        ...
        <div className="sg-controls">
          ...
          <div className="sg-genres">
            {["All", ...LANGUAGES].map(l => (
              <button key={l} className={`sg-genre-btn${activeLang === l ? " active" : ""}`} onClick={() => handleLang(l)}>
                {l}
              </button>
            ))}
          </div>
              ...
              return (
                <div key={m.id} className="sg-card" onClick={() => setPlaying(m)} style={{ cursor: "pointer" }}>
                  ...
                  <div className="sg-card-body">
                    ...
                    <div className="sg-card-meta">{m.language} · {m.year || "—"}</div>
                  </div>
                </div>
              );
            })}
